...
const fallbackEdgeNative = `${__dirname}\\${process.arch !== "x64" ? "x86" : "x64"}\\edge_nativeclr.node`;
process.env.EDGE_NATIVE = process.env.EDGE_NATIVE || fallbackEdgeNative;
...
var compileFunc = function (data, callback) {
    ...
    if (typeof func !== "function") {
        throw new Error("Node.js code must return an instance of a JavaScript function. Please use \"return\" statement to return a function.");
    }
